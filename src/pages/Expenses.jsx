...
export default function Expenses() {
  ...
  // Matches the `expenses.amount` column's numeric(12,2) definition
  // (supabase/migrations/0001_schema.sql) — anything at or above this
  // would otherwise round-trip to Supabase and fail with a generic
  // "numeric field overflow" (Postgres code 22003), surfaced to the
  // admin as an unhelpful "couldn't save" toast.
